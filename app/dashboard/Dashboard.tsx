        ...
        <div className="content" id="overview">
          ...
          <section className={`procore-connection ${procore.connected ? "connected" : ""}`} aria-label="Optional Procore source">
            ...
            <div className="procore-copy">
              ...
              <strong>{procore.loading ? "Checking Procore source…" : procore.connected ? "Procore source connected" : "Connect Procore to import into your jobs"}</strong>
              <small>{procore.connected ? `${procore.name || "Procore user"} · ${procore.login}` : "Jobs and manual plan uploads work without Procore. This connection remains available as an optional source."}</small>
            </div>
            {procore.connected ? (

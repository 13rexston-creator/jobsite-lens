      ...
      <main id="top" className="company-main">
        ...
        <section className="product-section" id="product">
          ...
          <div className="feature-grid">
            <article className="feature-large"><span className="feature-number">01</span><div className="ask-card"><p>Ask Jobsite Lens</p><div>Which RFIs could affect this week’s work?<button>↑</button></div><span><i>RFI 084</i><i>RFI 091</i><i>Look-ahead</i></span></div><h3>Ask about the work.</h3><p>Get concise answers grounded in the project information you’re permitted to access—with the source detail close at hand.</p></article>

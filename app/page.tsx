      ...
      <main id="top" className="company-main">
        <section className="hero">
          <div className="hero-copy">
            <div className="launch-pill"><span /> A clearer view of every construction project</div>
            <h1>Every project detail, one question away.</h1>
            <p>Jobsite Lens brings project information into one clear workspace—so construction teams can find what matters, understand what changed, and act with confidence.</p>
        ...
        <section className="product-section" id="product">
          <div className="section-kicker">THE JOBSITE LENS WORKSPACE</div><div className="section-heading"><h2>Less searching.<br/>More knowing.</h2><p>Construction information is spread across tools, projects, and teams. Jobsite Lens is designed to turn that complexity into a direct path from question to answer.</p></div>
          <div className="feature-grid">
            <article className="feature-large"><span className="feature-number">01</span><div className="ask-card"><p>Jobsite Lens in ChatGPT</p><div>Which drawings show Building A bathrooms?<button>↗</button></div><span><i>Search</i><i>Fetch</i><i>View plan</i></span></div><h3>Use ChatGPT with the job.</h3><p>Connect Jobsite Lens to ChatGPT, then search project information and inspect the prepared source drawings behind the answer.</p></article>
        ...
        <section className="how-section" id="how">
          ...
          <ol><li><b>01</b><span><strong>Connect your source systems</strong><small>Authorize the systems and companies you want Jobsite Lens to work with.</small></span></li><li><b>02</b><span><strong>Keep permissions intact</strong><small>Jobsite Lens is designed to respect the access granted by each connected account.</small></span></li><li><b>03</b><span><strong>Ask, review, and act</strong><small>Find the supporting project detail behind every answer before taking action.</small></span></li></ol>
        </section>
        ...
        <section className="company-section" id="company">
          ...
          <div className="company-detail"><p>Jobsite Lens is an independent construction technology company based in Colorado. We’re developing a secure, practical intelligence layer that helps project teams make better use of the information they already create.</p><p>The product is currently in early development. We’re starting with the workflows that cost construction teams the most time: finding current information, connecting related records, and understanding what requires attention.</p><div><span><b>2026</b><small>Founded</small></span><span><b>Colorado</b><small>Based</small></span><span><b>Private beta</b><small>Stage</small></span></div></div>
        </section>

        <section className="final-cta"><Mark/><h2>See the whole job.</h2><p>Explore the first Jobsite Lens workspace and follow the product as it develops.</p><a href="/dashboard">Open the workspace <span>→</span></a></section>
      </main>

      <footer className="company-footer"><a className="company-brand" href="#top"><Mark/><strong>JOBSITE LENS</strong></a><p>Independent construction technology, built in Colorado.</p><nav><a href="/privacy">Privacy</a><a href="/terms">Terms</a></nav><small>© 2026 Jobsite Lens. Procore is a trademark of Procore Technologies, Inc. Jobsite Lens is independent and is not endorsed by or affiliated with Procore.</small></footer>
    </div>
  );
}
